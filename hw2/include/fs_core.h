...
#define BLOCKS_P_PER_BLOCK  (BLOCK_SIZE / sizeof(block_pointer_t))
#define RECORDS_PER_BLOCK   (BLOCK_SIZE / sizeof(struct BlockDirectoryRecord))
 ...
 * --------------------
 * Prints full path of a directory.
 *
 * fs:      filesystem file
 * inode_p: inode number of the directory
 */
